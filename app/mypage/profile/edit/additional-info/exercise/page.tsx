      ...
      >
        ...
        <div className="bg-white shadow-sm sticky top-0 z-10">
          <div className="flex justify-between items-center px-4 py-3">
            ...
            <h1 className="text-lg font-medium">運動習慣</h1>
            <button 
              onClick={handleSave}
        ...
        <div className="p-4">
          ...
          <div className="mt-6 bg-white p-4 rounded-lg">
            <h3 className="text-sm font-medium mb-2">運動習慣について</h3>
            <p className="text-sm text-gray-600">
              ・運動習慣はライフスタイルや健康意識を表す重要な情報です<br />
              ・共通の運動習慣がある相手とマッチングすることで、一緒に運動する趣味を共有できます<br />
              ・健康志向の相手は運動習慣を重視する傾向があります
            </p>
          </div>
        </div>
      </motion.div>
